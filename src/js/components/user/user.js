...
class User extends MaharaBaseComponent {
  ...
  render() {
    ...
    return <section>
      ...
      <p className="userBlock"><img src={this.props.server && this.props.server.profile && this.props.server.profile.iconurl ? this.props.server.profile.iconurl : "image/profile-default.png"} className="profile"/> {this.props.server && this.props.server.profile && this.props.server.profile.myname ? this.props.server.profile.myname : ""}</p>
